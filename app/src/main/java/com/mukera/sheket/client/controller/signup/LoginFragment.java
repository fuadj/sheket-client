...
public class LoginFragment extends Fragment {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public static final String USER_LOGIN_KEY_COOKIE = "Cookie";
        public static final String USER_LOGIN_KEY_ERROR = "error";
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                ...
                if (!response.isSuccessful()) {
                    ...
                    errMsg = err.getString(USER_LOGIN_KEY_ERROR);
                    return false;
                }

                JSONObject result = new JSONObject(response.body().string());
                String login_cookie = result.getString(USER_LOGIN_KEY_COOKIE);
                SyncUtil.setLoginCookie(getActivity(), login_cookie);
