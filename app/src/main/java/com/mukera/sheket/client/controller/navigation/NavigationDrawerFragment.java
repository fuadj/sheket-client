...
public abstract class NavigationDrawerFragment extends Fragment {
    ...
    protected void setUp() {
        // TODO: fix this fkn hack
        if (mFragmentContainerId == 0 || mDrawerLayoutId == 0) {
            return;
        }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (mDrawerLayout != null && isDrawerOpen()) {
            ...
            // TODO: disabled the showing of App Name on Action Bar.
    ...
    public void setDrawerState(boolean opened) {
